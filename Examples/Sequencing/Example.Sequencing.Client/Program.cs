...
namespace Example.Sequencing.Client
{
    /// <summary>
    /// In this example, we are sending several mock files to the server in chunks and
    /// providing an example of ensuring that the chunks are processed in order.
    /// 
    /// The order is enforced by the RmSequenceBuffer on the server-side.
    /// </summary>
